...
This application generates three photo mosaics located in the same directory as the script “MosaicCollage.py”.
...
![ScreenShot1] (../master/ExampleMosaicOutputs/skyline_mosaic_50_[28,21]_tiles.gif)
## Video Link:
- 
